...
SubShader {
	...
	Pass {
		...
		#include "Assets/Plugins/FairyGUI/Extensions/TextMeshPro/Shaders/TMPro_Properties.cginc"
		#include "Assets/Plugins/FairyGUI/Extensions/TextMeshPro/Shaders/TMPro.cginc"
