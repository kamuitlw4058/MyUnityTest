...
namespace Lockstep.Math {
    ...
    public struct LFloat : IEquatable<LFloat>, IComparable<LFloat> {
        public const long Precision = 1000;
        ...
        public static readonly LFloat hundred = new LFloat(true,100000L);
        ...
        public static LFloat operator /(LFloat a, LFloat b){
            long val = a._val * Precision / b._val;
        ...
        public override bool Equals(object obj){
            return obj is LFloat lFloat && lFloat._val == _val;
        }
