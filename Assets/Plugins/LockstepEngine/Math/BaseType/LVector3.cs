...
namespace Lockstep.Math
{
    ...
    public struct LVector3 : IEquatable<LVector3>
    {
        ...
        {
            long num = this._x * 100;
            long num2 = this._y * 100;
            long num3 = this._z * 100;
        ...
        public LVector3 RotateY(LFloat degree)
        {
            ...
            LVector3 vInt;
            vInt._x = (this._x * s._val + this._z * c._val) / LFloat.Precision;
            vInt._z = (this._x * -c._val + this._z * s._val) / LFloat.Precision;
            vInt._y = 0;
        ...
        public static LVector3 operator *(LVector3 lhs, LVector3 rhs)
        {
            lhs._x = (lhs._x * rhs._x) / LFloat.Precision;
            lhs._y = (lhs._y * rhs._y) / LFloat.Precision;
            lhs._z = (lhs._z * rhs._z) / LFloat.Precision;
            return lhs;
        }

        public static LVector3 operator *(LVector3 lhs, LFloat rhs)
        {
            lhs._x = (lhs._x * rhs._val) / LFloat.Precision;
            lhs._y = (lhs._y * rhs._val) / LFloat.Precision;
            lhs._z = (lhs._z * rhs._val) / LFloat.Precision;
            return lhs;
        }

        public static LVector3 operator /(LVector3 lhs, LFloat rhs)
        {
            lhs._x = lhs._x * LFloat.Precision / rhs._val;
            lhs._y = lhs._y * LFloat.Precision / rhs._val;
            lhs._z = lhs._z * LFloat.Precision / rhs._val;
            return lhs;
        }
        ...
        {
            var val = lhs._x * rhs._x + lhs._y * rhs._y + lhs._z * rhs._z;
        ...
        public static LVector3 Cross(ref LVector3 lhs, ref LVector3 rhs)
        {
            return new LVector3(true,
                (lhs._y * rhs._z - lhs._z * rhs._y) / LFloat.Precision,
                (lhs._z * rhs._x - lhs._x * rhs._z) / LFloat.Precision,
                (lhs._x * rhs._y - lhs._y * rhs._x) / LFloat.Precision
            );
        }
        ...
        {
            return new LVector3(true,
                (b._x - a._x) * f._val / LFloat.Precision + a._x,
                (b._y - a._y) * f._val / LFloat.Precision + a._y,
                (b._z - a._z) * f._val / LFloat.Precision + a._z);
        }
    }
}