...
namespace Lockstep.Util
{
    public static class HashCodeExtension
    {
        ...
        {
            return PrimerLUT.GetPrimer(val._x) + PrimerLUT.GetPrimer(val._y) * 31 + PrimerLUT.GetPrimer(val._z) * 37;
        }

        public static int GetHash(this Vector3 val, ref int idx)
        {
            return val.GetHashCode();
        }

        public static int GetHash(this Grid val, ref int idx)
        {
            return val.GetHashCode();
        }
    }
